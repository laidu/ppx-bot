package org.ppx.ai.bot.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof org.ppx.ai.bot.service.EmailAlreadyUsedException ||
            ex instanceof org.ppx.ai.bot.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof org.ppx.ai.bot.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "org.ppx.ai.bot");
    }
}
